...
def generate_simple_model(input_columns, output_columns, layers_num=2, network_size=128, dropout=0.2):
...
def keras_slice_layer(layer, layer_labels, pattern=None, sel_f=None):
    if sel_f is None:
